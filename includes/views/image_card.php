...
function star_rating_render($rating) {
  $final_str = "";
   ...
   * @param string   $max_height  The max height in px for the card
	 */
function image_card($point, $image_size, $max_height) {
  if (!$point) {
    return;
  }
        ...
        <div class="akzent-point-of-interest-image-card-footer akzent-w100">
          <div class="bottom-footer">
            ...
            <div class="akzent-point-of-interest-rating-wrapper">
              <span class="akzent-point-of-interest-rating"><?php echo star_rating_render($point->rating) ?></span>
            </div>
          </div>
